...
#define ov13850_AEC_PK_LONG_GAIN_HIGH_REG 0x350A	/* Bit 2-0    gain 10 -8 */
#define ov13850_AEC_PK_LONG_GAIN_LOW_REG	 0x350B	/* Bits 7 -0  gain  7-0 */
...
#define ov13850_FETCH_3RD_BYTE_EXP(VAL) (((VAL) >> 12) & 0xF)	/* 4 Bits */
#define ov13850_FETCH_2ND_BYTE_EXP(VAL) (((VAL) >> 4) & 0xFF)	/* 8 Bits */
#define ov13850_FETCH_1ST_BYTE_EXP(VAL) (((VAL) & 0x0F) << 4)	/* 4 Bits */
...
static struct ov_camera_module_reg ov13850_init_tab_4224_3136_7fps[] = {
/* global setting */
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x350b ,0x3f },  //xhh  , 0x80  ,0x3f
	...
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5e00 ,0x00 },   //xhh 0x00  0x80
#else
	{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x5e00 ,0x80 },   //xhh 0x00  0x80
#endif
    ...
    {OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4800 ,0x24 }  //gate clk
...
static struct ov_camera_module_reg ov13850_init_tab_2112_1568_30fps[] = {
...
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x0103 ,0x01}, 
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x0300 ,0x01},	//for 640Mbps
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x0301 ,0x00},
...
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x3010 ,0x01}, 
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x3011 ,0x76}, 
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x3012 ,0x11}, //1lane
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x3013 ,0x12}, 
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x3014 ,0x11}, 
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x301f ,0x03}, 
{OV_CAMERA_MODULE_REG_TYPE_DATA ,0x3106 ,0x00}, 
...

{
	...
	.auto_gain_enabled = false,
	.auto_wb_enabled = false,
	.reg_table = (void *)ov13850_init_tab_4224_3136_7fps,
	.reg_table_num_entries =
		sizeof(ov13850_init_tab_4224_3136_7fps) /
		sizeof(ov13850_init_tab_4224_3136_7fps[0]),
	.v_blanking_time_us = 5000,
	PLTFRM_CAM_ITF_MIPI_CFG(0, 2, 600, ov13850_EXT_CLK)
}
